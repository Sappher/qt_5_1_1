...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QMYSQLDriver_t, stringdata) + ofs \
...
const QMetaObject QMYSQLDriver::staticMetaObject = {
    { &QSqlDriver::staticMetaObject, qt_meta_stringdata_QMYSQLDriver.data,
      qt_meta_data_QMYSQLDriver,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QMYSQLDriver.stringdata))
